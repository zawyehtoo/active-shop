...
@section('content')
    <div class="container">
        <p class="my-3 "><span class="text-black-50">Home / Shop / </span>Kids</p>
        <h1>Kids' Products</h1>
        <hr>
        <div class="d-flex">
            <div class="col-md-2">
                ...
                <ul class="list-unstyled">
                    @foreach($categories as $category)
                        <li class="mb-2"><a href="{{url('kids-shop/'.$category->id)}}" class="text-dark text-decoration-none ">{{$category->categories}}</a></li>
                    @endforeach
                </ul>
            </div>
            @if($products->isEmpty())
